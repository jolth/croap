...
"""SOAP ControlT
By: Jorge Toro 
    <jorge.toro at devmicrosystem dot com>
    <jolth at gmail dot com>

Copyright May 2021
"""
from contextlib import closing
from db import connect, credentials
...
def vehicles_fetchall(ws_name):
    ...
    v.placa, v.gps_id, g.imei, g.name,
    lpg.fecha, lpg.velocidad, lpg.odometer, lpg.position, 
